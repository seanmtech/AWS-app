...
resource "aws_api_gateway_method_response" "contacts_200_response" {
  rest_api_id = aws_api_gateway_rest_api.cay_api_gateway.id
  resource_id = aws_api_gateway_resource.contacts.id
...
resource "aws_api_gateway_method_response" "health_200_response" {
  rest_api_id = aws_api_gateway_rest_api.cay_api_gateway.id
...
resource "aws_api_gateway_method_response" "addImage_200_response" {
  rest_api_id = aws_api_gateway_rest_api.cay_api_gateway.id
  resource_id = aws_api_gateway_resource.addImage.id
  http_method = aws_api_gateway_method.addImage_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration" "contact_id_options" {
  rest_api_id = aws_api_gateway_rest_api.cay_api_gateway.id
  resource_id = aws_api_gateway_resource.contact_id.id
  http_method = aws_api_gateway_method.contact_id_options.http_method
  type        = "MOCK"
}
